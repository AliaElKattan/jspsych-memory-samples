...
function generate_taskmap(canvas_width, canvas_height, center, radius) {
    ...
    var target_coords = random_along_circumference(center, radius);
    var target_polar = pixeltoPolar(canvas_width,canvas_height,target_coords);

    var distractor_coords = random_along_circumference(center, radius);
    var distractor_polar = pixeltoPolar(canvas_width,canvas_height,distractor_coords);

    var filler_1_coords = random_along_circumference(center, radius);
    var filler_1_polar = pixeltoPolar(canvas_width,canvas_height,filler_1_coords);

    var filler_2_coords = random_along_circumference(center, radius);
    var filler_2_polar = pixeltoPolar(canvas_width,canvas_height,filler_2_coords);


    while (Math.abs(distractor_polar.polar_angle - target_polar.polar_angle) <= 30) {
            distractor_coords = random_along_circumference(center, radius);
            distractor_polar = pixeltoPolar(canvas_width,canvas_height,distractor_coords);
    } 
    ...
    while (Math.abs(filler_1_polar.polar_angle - target_polar.polar_angle) <= 30 || Math.abs(filler_2_polar.polar_angle - target_polar.polar_angle) <= 30 || Math.abs(filler_2_polar.polar_angle - filler_1_polar.polar_angle) <=30) {
            filler_1_coords = random_along_circumference(center, radius);
            filler_1_polar = pixeltoPolar(canvas_width,canvas_height,filler_1_coords);

            filler_2_coords = random_along_circumference(center, radius);
            filler_2_polar = pixeltoPolar(canvas_width,canvas_height,filler_2_coords);
    }
    ...
    while (target_color === filler_1_color || target_color === filler_2_color || filler_1_color === filler_2_color) {
